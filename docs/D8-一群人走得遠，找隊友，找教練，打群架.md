...
![D8-一群人走得遠，找隊友，找教練，打群架](/docs/img/D8.png)
...
![DevOps Taiwan](/docs/img/D8-3.png)
...
![Site Reliability Engineering Taiwan](/docs/img/D8-4.png)
...
![AWS User Group Taiwan](/docs/img/D8-5.png)
...
![Azure Taiwan User Group](/docs/img/D8-6.png)
...
![GDG Kaohsiung 社群](/docs/img/D8-7.png)
...
![AWS User Group Taiwan](/docs/img/D8-8.png)
...
![ChatGPT 4.0 + Copilot and ALL AI 生成式藝術小小詠唱師](/docs/img/D8-9.png)
...
![生成式 AI 論壇](/docs/img/D8-10.png)

總結一下，找隊友有三個好處：

* `建立求職小組`：與同屆同學或同行的朋友組成求職小組，定期交流求職進度
和心得。
* `分享資源`：互相分享有價值的求職資源，如招聘情報、學習材料、面試經驗等。
...
02. `設立明確的退場機制`：如已經找到工作，或者讀書會三次未出現，這樣可以
